...
#include <math.h>
  ...
  {
    void *sp = fp;
    char *s = (char *)pwart_rstack_get_ref(&sp);
    uint32_t n = strlen(s);
    sp = fp;
  ...
  void insn_load_module(void *fp)
  {
    ...
    char *wasm_bytes = (char *)pwart_rstack_get_ref(&sp);
  ...
  void insn_import(void *fp)
  {
    ...
    req.import_module = (char *)pwart_rstack_get_ref(&sp);
    req.import_field = (char *)pwart_rstack_get_ref(&sp);
